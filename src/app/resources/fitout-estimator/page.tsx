          ...
          {step === 5 && (
            <div className="max-w-2xl">
              ...
              <div className="flex items-center" style={{ gap: '1.5rem' }}>
                ...
                <button onClick={() => getBack(5)} className="text-white/30 hover:text-white/60 transition-colors" style={{ fontSize: '0.82rem', letterSpacing: '0.05em' }}>← Back</button>
              </div>
            </div>
          )}
          ...
          {step === 6 && (
            <div className="max-w-xl">
              ...
              <div className="flex items-center" style={{ gap: '1.5rem' }}>
                ...
                <button onClick={() => getBack(6)} className="text-white/30 hover:text-white/60 transition-colors" style={{ fontSize: '0.82rem', letterSpacing: '0.05em' }}>← Back</button>
              </div>
            </div>
          )}
          ...
          {step === 7 && (
            <div className="max-w-xl">
              ...
              <div className="flex items-center" style={{ gap: '1.5rem' }}>
                ...
                <button onClick={() => getBack(7)} className="text-white/30 hover:text-white/60 transition-colors" style={{ fontSize: '0.82rem', letterSpacing: '0.05em' }}>← Back</button>
              </div>
            </div>
          )}
