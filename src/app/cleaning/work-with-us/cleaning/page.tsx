...
export const metadata: Metadata = {
  ...
  description: 'Join a growing Newcastle commercial cleaning team. Consistent work, fair pay, local management. Positions open for employees and contractors.',
...
export default function CleaningWorkWithUsPage() {
  return (
    <>
      <Nav />
      ...
      <section style={{ background: '#0f0f0f', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '0.875rem 0' }}>
        <div className="max-w-screen-xl mx-auto" style={{ paddingLeft: 'clamp(1.5rem,8vw,10rem)', paddingRight: 'clamp(1.5rem,8vw,10rem)', display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <a href="/cleaning/work-with-us"
            style={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.72rem', letterSpacing: '0.08em', textDecoration: 'none', padding: '0.3rem 0.875rem', border: '1px solid rgba(255,255,255,0.1)', display: 'inline-block', transition: 'all 0.15s' }}>
            Commission Sales Consultants →
          </a>
        </div>
      </section>
