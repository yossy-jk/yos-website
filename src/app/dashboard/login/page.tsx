...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <form onSubmit={handleSubmit} style={{ background: 'rgba(0,181,165,0.06)', border: '1px solid rgba(0,181,165,0.2)', padding: '2.5rem', borderRadius: 8, width: '100%', maxWidth: 360 }}>
        ...
        <input type="password" value={password} onChange={e => setPassword(e.target.value)} autoFocus disabled={loading}
        ...
        <button type="submit" disabled={loading || !password}
          style={{ width: '100%', padding: '0.75rem', background: loading || !password ? 'rgba(0,181,165,0.3)' : '#00B5A5', border: 'none', borderRadius: 4, color: 'white', fontSize: '1rem', fontWeight: 500, cursor: loading || !password ? 'not-allowed' : 'pointer' }}>
