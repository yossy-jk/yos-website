    ...
    return (
      <>
        ...
        <section className="bg-teal py-10">
          <FadeIn>
            <div className="max-w-5xl mx-auto px-5 md:px-10 grid grid-cols-3 gap-6 text-center">
              {[
        ...
        <section className="bg-white py-14 border-t border-gray-100">
          <div className="max-w-5xl mx-auto px-5 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-10">
            <FadeIn direction="left">
              <div>
