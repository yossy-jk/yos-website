    ...
    <>
        ...
        "@graph": [
          {
            ...
            "description": "Commercial office furniture selection, supply and installation from Newcastle across NSW.",
            "address": {
              "@type": "PostalAddress",
          ...
          },
          {
            ...
            "description": "Commercial workstations and desking systems, including fixed and height-adjustable options, selected for the workplace brief.",
      ...
      <section className="relative min-h-screen flex items-center bg-near-black"
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto" style={PAD}>
          <FadeIn delay={0}>
            <SectionLabel>Commercial Office Furniture</SectionLabel>
          </FadeIn>
          <FadeIn delay={100}>
            <h1 className="text-white font-black leading-[0.95] tracking-tight max-w-4xl mb-6 sm:mb-8"
              style={{ fontSize: 'clamp(2rem,6vw,6rem)' }}>
              Office furniture selected
              <br /><span className="text-teal">for the way you work.</span>
            </h1>
          </FadeIn>
          <FadeIn delay={200}>
            <p className="text-white/80 font-light leading-relaxed max-w-2xl mb-8 sm:mb-12"
              style={{ fontSize: 'clamp(1.05rem, 2vw, 1.375rem)' }}>
              Workstations, seating, meeting tables, storage and breakout furniture selected around your people, space, budget and programme.
            </p>
          </FadeIn>
          <FadeIn delay={300}>
            <div className="flex flex-row flex-wrap gap-4 items-center">
              ...
              <a href="/contact?service=furniture"
        ...
        <div className="max-w-screen-xl mx-auto" style={PAD}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              { src: '/images/furniture/space-cogc-wide.jpg',          alt: 'Contemporary commercial office setting',               label: 'Corporate',       mood: 'Clean & Modern' },
            ...
            {[
              {
                ...
                body: "Lead times vary by product, finish and quantity. Tell us the required date at the start and we will confirm the available options before order."
              },
              {
              ...
              },
              {
                ...
                title: 'Brief-led selection',
                body: "Products are assessed against use, dimensions, finish, budget and programme before they are specified."
              },
              {
                ...
                body: 'The quote records products, quantities, inclusions, delivery, installation and payment milestones before order.'
              },
              {
      ...
      <section style={SEC_SM} className="bg-[#0D1117] border-y border-white/5">
        <div className="max-w-screen-xl mx-auto" style={PAD}>
          <FadeIn>
            <p className="text-white/30 font-light text-xs tracking-widest uppercase text-center mb-8">Furniture planned by function</p>
            <div className="flex flex-wrap justify-center gap-8 items-center opacity-60">
              {['Focused Work', 'Collaboration', 'Meetings', 'Storage', 'Breakout'].map(name => (
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center" style={PAD}>
          <FadeIn direction="left">
            <div>
              ...
              <h2 className="text-white font-bold leading-tight mt-3 mb-8"
                ...
                Furniture selected around the workplace, not a generic catalogue.
              </h2>
              <p className="text-white/60 font-light leading-relaxed mb-12 max-w-2xl" style={{ fontSize: 'clamp(1rem,1.8vw,1.15rem)', lineHeight: 1.85 }}>
                We start with the floor plan, team needs, product use, budget and programme. The specification follows that brief.
              </p>
          ...
          <FadeIn direction="right">
            <div className="flex flex-col gap-6">
              {[
                { label: 'Workstations', body: 'Fixed and height-adjustable settings planned around people and space.' },
                { label: 'Seating', body: 'Task, meeting and breakout seating selected for its actual use.' },
                { label: 'Meeting spaces', body: 'Tables, seating and supporting furniture for how teams gather.' },
                { label: 'Storage and breakout', body: 'Shared storage, personal storage and informal settings.' }
              ].map((item) => (
        ...
        <div className="max-w-screen-xl mx-auto" style={PAD}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { step: '03', title: 'Source & Deliver', body: 'We match products to the approved specification and confirm current lead times before order.' },
